...
from ..structs import RepositioningState, RepositioningSceneConfig, JointTorques, Image
...
class DynamicsModelEnv(RepositioningEnv):
    ...
    def __init__(self, dynamics_name: str, scene_config: RepositioningSceneConfig | None = None,
                 *args, **kwargs) -> None:
        ...
        self._physics_client_id = create_gui_connection(camera_target=self._scene_config.camera_target,
                                                  camera_distance=self._scene_config.camera_distance,
                                                  camera_pitch=self._scene_config.camera_pitch)
        self._dynamics_model = create_dynamics_model(dynamics_name, self._physics_client_id, self._scene_config)
    ...
    def _initial_state(self) -> RepositioningState:
        return RepositioningState(self._scene_config.active_init_joint_positions,
    ...
    def get_goal(self) -> RepositioningState:
        return RepositioningState(self._scene_config.active_goal_joint_positions,
    ...
    def get_torque_limits(self) -> tuple[JointTorques, JointTorques]:
        return self._scene_config.lower_torque_limits, self._scene_config.upper_torque_limits
    
    def render(self) -> Image:
        return capture_image(self._physics_client_id,
                             camera_distance=self._scene_config.camera_distance,
                             camera_pitch=self._scene_config.camera_pitch,
