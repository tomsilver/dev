...
def extract_lpp_from_dt(estimator, features, feature_log_probs):
    ...
    if not isinstance(disjunctive_program, Feature):
        disjunctive_program = Feature(disjunctive_program)
